...
export default function ActivityResponses({ activityId, classroomId, questions }) {
  ...
  return (
    <div className="space-y-3">
      {responses.length === 0 ? (
        ...
        <button key={r.id} onClick={() => setSelected(r.id)} className="w-full bg-card border border-border rounded-xl p-4 flex items-center gap-3 hover:border-primary/40 transition-colors text-left">
